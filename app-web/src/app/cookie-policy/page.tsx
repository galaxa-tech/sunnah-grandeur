        ...
        <div className="max-w-4xl mx-auto px-gutter">
          ...
          <div className="prose prose-invert max-w-none space-y-8 font-body-md text-text-secondary text-sm md:text-base leading-relaxed">
            ...
            <section className="space-y-4 border-t border-border-subtle pt-8">
              <p>
                For questions regarding our privacy practices or data policies, please contact us at <a href="mailto:info@sunnahgrandeur.us" className="text-primary-container hover:underline">info@sunnahgrandeur.us</a>.
              </p>
            </section>
          </div>
