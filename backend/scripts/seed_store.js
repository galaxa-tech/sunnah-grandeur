...
const products = [
  ...
  { id:"8",  name:"Wooden Tasbih 99-Bead",             category:"Salah & Worship",categoryId:"salah",     priceInCents:38000,  originalPriceInCents:null,   images:[],                        description:"Hand-crafted 99-bead tasbih from olive wood with bronze accent pieces.", bgGradient:"linear-gradient(145deg, #2a2115 0%, #3d3220 50%, #2a2115 100%)", bgIcon:"scatter_plot", isFeatured:false, badge:null,        isActive:true, stockQuantity:200, sku:"SA-008" },
